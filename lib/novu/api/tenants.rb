...
module Novu
    class Api
        ...
        #
        # For more information on the tenants feature (https://docs.novu.co/tenants/introduction), for API documentation see https://docs.novu.co/api-reference/tenants/get-tenants.
        module Tenants
            # Create a tenant
            #
            # @bodyparams:
